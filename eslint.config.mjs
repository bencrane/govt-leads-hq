...
// `packages/eslint-plugin-govt-leads-hq`.

import tsParser from "@typescript-eslint/parser";
import rareStructurePlugin from "eslint-plugin-govt-leads-hq";
...
export default [
  {
    ...
    plugins: {
      "govt-leads-hq": rareStructurePlugin,
    },
    rules: {
      "govt-leads-hq/no-route-geometry": "error",
    },
  },
];
